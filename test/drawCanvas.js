...
describe('drawCanvas', function() {
	it('should color the canvas all white', function() {
		...
		canvas = funPaint.drawRect(canvas, width, true, 0, 0, 16, 16, [0, 0, 0, 0]);
		canvas2 = funPaint.drawRect(canvas2, width, true, 0, 0, 16, 16, [0xff, 0xff, 0xff, 0xff]);
		canvas = funPaint.drawBuffer(canvas, width, true, canvas2, width, true, 0, 0);
	...
	it('should color the canvas all white', function() {
		...
		canvas = funPaint.drawRect(canvas, width, true, 0, 0, 16, 16, [0xff, 0xff, 0xff, 0xff]);
		canvas2 = funPaint.drawRect(canvas2, width, true, 0, 0, 16, 16, [0xff, 0xff, 0xff, 0]);
		canvas = funPaint.drawBuffer(canvas, width, true, canvas2, width, true, 0, 0);
		assert.deepEqual(imageBuffer, canvas);
	});
	...
	it('should draw a black square in the middle', function() {
		...
		canvas = funPaint.drawRect(canvas, width, true, 0, 0, 16, 16, [255, 255, 255, 0]);
		canvas = funPaint.drawRect(canvas, width, true, 4, 4, 8, 8, [0, 0, 0, 255]);
	...
	it('should draw a black square in the middle', function() {
		...
		canvas3 = funPaint.drawRect(canvas3, 8, true, 0, 0, 8, 8, [0, 0, 0, 255]);
		canvas = funPaint.drawBuffer(canvas, width, true, canvas3, 8, true, 4, 4);
	...
	it('should draw two overlapping black squares', function() {
		...
		canvas3 = funPaint.drawRect(canvas3, 8, true, 0, 0, 8, 8, [0, 0, 0, 255]);
		canvas = funPaint.drawBuffer(canvas, width, true, canvas3, 8, true, 4, 4);
		canvas = funPaint.drawBuffer(canvas, width, true, canvas3, 8, true, 8, 8);
	...
	it('should draw two overlapping black squares', function() {
		...
		canvas2 = [...canvas];
		canvas = funPaint.drawBuffer(canvas, width, true, canvas2, width, true, 4, 4);
	...
	it('should draw a red rectangle', function() {
		...
		canvas4 = funPaint.drawRect(canvas4, width, true, 0, 0, 16, 32, [255, 255, 255, 0]);

		canvas4 = funPaint.drawBuffer(canvas4, width, true, imageBuffer, width, true, 0, 0);
